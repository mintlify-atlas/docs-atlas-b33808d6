---
title: "Timer — Custom Scheduled Callbacks in sb0t Scripts"
sidebarTitle: "Timer"
description: "API reference for sb0t's Timer instance. Schedule JavaScript callbacks on any custom interval, independent of the built-in onTimer event."
---
