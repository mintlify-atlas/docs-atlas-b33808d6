---
title: "User Object — sb0t JavaScript Scripting API"
sidebarTitle: "User"
description: "API reference for the JSUser object in sb0t scripts. Read user properties, send messages, ban, redirect, and modify user state."
---
...
<ParamField path="quarantined" type="bool">
  `true` if the user is in the quarantine holding area and has not yet been admitted to the room. **Read-only.**
</ParamField>
