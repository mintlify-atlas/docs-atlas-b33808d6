...
description: "Reference for the static JavaScript objects available in every sb0t script: Room, Users, Link, Crypto, Stats, File, Channels, Base64, Zip, Registry, Hashlink, and Spelling."
---
...
| `user.font` | `JSUserFont` | read-only | Font settings (`enabled`, `nameColor`, `textColor`, `family`). |
